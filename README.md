# Weathernow Website Documentation
## Introduction
...
This project is distributed under the GNU General Public License (GPL). You can find the full text of the license in the [LICENSE](https://github.com/arpn0z/weathernow/blob/main/LICENSE) file.
